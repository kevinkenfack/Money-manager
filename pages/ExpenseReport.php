...
?>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
            <a href="admin.php?page=Transaction" class="btn white btn-success "><i class="fa fa-plus"></i> <?php echo $NewTransaction; ?></a>
                    ...
                    <div class="panel panel-red">
	                	...
	                	<tbody>
							...
							<td colspan="2" class="notification">
								<a href="admin.php?page=ManageExpense&id=<?php echo $col['BillsId'];?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs glyphicon glyphicon-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo $EditExpense; ?>"></span></a>
