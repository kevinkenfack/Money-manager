                ...
                <div class="col-lg-6">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                           ...
                           <div class="text-center"><a href="admin.php?page=AssetReport"><?php echo $ViewDetails;?></a></div>
                           </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                                ...
                                <div class="col-lg-12">
									<?php while($BudgetCols =mysqli_fetch_assoc($Budgets)) { 
										...
										if($Exceed<0 OR $Exceed >100){
												$Exceed = '<label class="label label-danger">Dépassement du budget</label>';
                 ...
                 <div class="panel panel-red">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="text-center"><a href="admin.php?page=ExpenseReport"><?php echo $ViewDetails;?></a></div>
                                <!-- /.col-lg-4 (nested) -->
