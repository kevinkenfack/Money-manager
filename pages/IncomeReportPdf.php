...
$pdf = new TCPDF('L', 'mm', 'A4', true, 'UTF-8', false);
	...
	$pdf->SetTitle('Rapport De Revenue');

	// set default header data
	$pdf->SetHeaderData('logo.gif', '11', 'Finance Manager', 'Rapport De Revenue', array(0,64,255), array(0,64,128));
	...
	$pdf->Output('Releves_Revenues.pdf', 'D');
