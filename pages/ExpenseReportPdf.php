...
$pdf = new TCPDF('L', 'mm', 'A4', true, 'UTF-8', false);
	...
	$pdf->SetCreator('Finance Manager');
	$pdf->SetTitle('Rapport de dépenses');

	// set default header data
	$pdf->SetHeaderData('logo.gif', '11', 'Finance Manager', 'Rapport de dépenses', array(0,64,255), array(0,64,128));
	...
	$pdf->Output('Rapport_Depenses.pdf', 'D');
