                    ...
                    <div class="panel panel-primary">
	                	...
	                	<tbody>
							...
							<td colspan="2" class="notification">
								<a href="admin.php?page=ManageIncome&id=<?php echo $col['AssetsId'];?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs glyphicon glyphicon-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo $EditIncome ;?>"></span></a>
