...
(1, 'admin', 'admin', 'admin@gmail.com', 'LjQIdwGE9y5PgLMZdbn8WtWcH8LFTpnoJ1Kx7HnpCes=', '$');

--
-- Triggers `user`
--
DELIMITER $$
CREATE TRIGGER `GenerateDefaultAccount` AFTER INSERT ON `user` FOR EACH ROW INSERT INTO account (UserId, AccountName) VALUES (new.UserId, 'Cash'), (new.UserId, 'Compte'), (new.UserId, 'Carte de credit')
$$
DELIMITER ;
